...
@section('content')
    ...
    <div id="appCapsule" class="full-height">
        ...
        <div class="appHeader">
            ...
            <div class="pageTitle"> 
                <button type="button" class="btn btn-text-primary rounded shadowed"  data-bs-toggle="modal" data-bs-target="#booking_secah_form">My Bookings</button>
            </div>
                     ...
                     <div class="row">
                        <div class="col-6">
                           <div class="form-group">
                              <label>From</label>
                              <input type="date" id="from_date" value="{{$searched_data['searched_from_date']}}">
                           </div>
                        </div>
                        <div class="col-6">
                           <div class="form-group">
                              <label>To</label>
                              <input type="date" id="to_date" value="{{$searched_data['searched_to_date']}}">
                           </div>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <button type="button"
                         class="btn btn-primary btn-lg btn-block mt-2 me-1 mb-2 apply_booking_search">Apply</button>
                   </div>
                </div>
             </div>
          </div>
...
<script src='https://maps.googleapis.com/maps/api/js?key=AIzaSyCRu_qlT0HNjPcs45NXXiOSMd3btAUduSc&libraries=places'></script>
...
<script type="text/javascript">
    ...
    $(document).on('click', '.apply_booking_search', function() {
       ...
       var routeUrl = baseUrl + "/m/booking-list" + "?from_date=" + from_date + "&to_date=" +
           to_date + "&space_name=" + space_name + "&city=" + city + "&list_id=" + list_id + "&amount_from=" + amount_from +
           "&amount_to=" + amount_to  ;
