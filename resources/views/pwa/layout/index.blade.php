...
<link rel="manifest" href="{{ url('pwa') }}/__manifest.json">
...
<link rel="icon" type="image/x-icon" href="{{url('images/favicon-512x512.png')}}">

<!-- ios support -->
<link rel="apple-touch-icon" href="{{url('images/favicon-72x72.png')}}" />
<link rel="apple-touch-icon" href="{{url('images/favicon-96x96.png')}}" />
<link rel="apple-touch-icon" href="{{url('images/favicon-128x128.png')}}" />
<link rel="apple-touch-icon" href="{{url('images/favicon-144x144.png')}}" />
<link rel="apple-touch-icon" href="{{url('images/favicon-152x152.png')}}" />
<link rel="apple-touch-icon" href="{{url('images/favicon-192x192.png')}}" />
<link rel="apple-touch-icon" href="{{url('images/favicon-384x384.png')}}" />
<link rel="apple-touch-icon" href="{{url('images/favicon-512x512.png')}}" />
