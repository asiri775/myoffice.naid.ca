...
<head>
    ...
    <link rel="apple-touch-icon" href="user_pages/ico/60.png">
    <link rel="apple-touch-icon" sizes="76x76" href="user_pages/ico/76.png">
    <link rel="apple-touch-icon" sizes="120x120" href="user_pages/ico/120.png">
    <link rel="apple-touch-icon" sizes="152x152" href="user_pages/ico/152.png">
    ...
    <link href="{{ asset('user_assets/plugins/datatables-responsive/css/datatables.responsive.css') }}" rel="stylesheet"
          type="text/css"
          media="screen"/>
    ...
    <link href="{{ asset('user_assets/plugins/pace/pace-theme-flash.css') }}" rel="stylesheet" type="text/css"/>
    <link href="{{ asset('user_assets/plugins/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css"/>
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link href="{{ asset('user_assets/plugins/jquery-scrollbar/jquery.scrollbar.css')}}" rel="stylesheet"
          type="text/css" media="screen"/>
...
<div class="overlay hide" data-pages="search">
    ...
    <div class="overlay-content has-results m-t-20">
        ...
        <div class="container-fluid">
            ...
            <!-- END Overlay Logo !-->
            <!-- BEGIN Overlay Close !-->
            <a id="search_close" href="#" class="close-icon-light btn-link btn-rounded  overlay-close text-black">
...
<script type="text/javascript"
        src="{{ asset('user_assets/plugins/bootstrap-tag/bootstrap-tagsinput.min.js') }}"></script>
<script type="text/javascript"
        src="{{ asset('user_assets/plugins/jquery-inputmask/jquery.inputmask.min.js') }}"></script>
<script src="{{ asset('user_assets/plugins/bootstrap-form-wizard/js/jquery.bootstrap.wizard.min.js') }}"
        type="text/javascript"></script>
<script src="{{ asset('user_assets/plugins/jquery-validation/js/jquery.validate.min.js') }}"
        type="text/javascript"></script>
...
<script src="{{ asset('user_assets/plugins/jquery-sparkline/jquery.sparkline.min.js') }}"
        type="text/javascript"></script>
                ...
                success: function (data) {
                    if (data['bookings'] != null) {
                        ...
                        jQuery.each(data['bookings'], function (i, val) {
                            $("#results").append("<div class='d-flex m-t-15'><div class='p-l-10'><h5 class='no-margin'>" + val['id'] + " <a href='" + "{{ url('user/booking-details') }}" + "/" + val['id'] + "'>" + val['title'] + "</a><h5></div></div>"
                        )
                            ;
                        });
                    } else {
