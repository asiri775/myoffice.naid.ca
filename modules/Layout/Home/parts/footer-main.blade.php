...
<script type="text/javascript" src="{{\App\Helpers\CodeHelper::withAppUrl('js/signinpopup.js')}}?v=1"></script>
...
@if (!is_api())
    <footer class="mainfooter">
        <div class="container">
            ...
            <div class="clearfix"></div>
            <div class="copyright">
                Copyright &copy; {{date('Y')}} My Office Inc. All Rights Reserved.
            </div>
...
<script type="text/javascript" src="{{ asset('js/signinpopup.js') }}?v=1"></script>
{{-- Lazy Load --}}
