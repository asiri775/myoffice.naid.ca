                ...
                <div class="col-lg-4 d-none">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" min="0" name="price" class="form-control"
                                value="{{ old('price', $row->price) }}" placeholder="{{ __('Space Price') }}">
                        </div>
                    </div>
                    <div class="col-lg-4 d-none">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" name="sale_price" class="form-control"
                                value="{{ old('sale_price', $row->sale_price) }}" placeholder="{{ __('Space Sale Price') }}">
                    ...
                    <div class="col-lg-12">
                        <div class="form-group">
                            ...
                            <input type="number" step="any" name="hours_after_full_day" class="form-control"
                                value="{{ old('hours_after_full_day', $row->hours_after_full_day) }}" placeholder="{{ __('Full Day After Hours') }}">
                    ...
                    <div class="col-lg-4 d-none">
                        <div class="form-group">
                            ...
                            <input type="number" min="0" name="discount" class="form-control"
                                value="{{ old('discount', $row->discount) }}" placeholder="{{ __('Discount %') }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        function setDefaultPrice(price_id) {
                            ...
                            jQuery.ajax({
                                ...
                                success: function(result) {
                                    for (var i = 0; i < 5; i++) {
                                        $('.user-form-settings .setDefaultprice_' + i).html(
                                            '<a href="#" onclick="setDefaultPrice(' + i + ');" >Set Default</a>');
                                    }
                                    if (current_price) {
                                        $('.user-form-settings .viewDefaultPrice_' + current_price).html(
                                            '<a href="#" onclick="setDefaultPrice(' + current_price + ');" >Set Default</a>'
                                        );
                                    }
                                    $('.user-form-settings .setDefaultprice_' + price_id).html('<span >Default</span>');
                                }
                            });
                        }
                    </script>
                    <table class="table" style="border-bottom:1px solid #ccc">
                        <tr>
                            ...
                            <th width="30%">Discounted Rate</th>
                            <th width="20%">Set Default</th>
                        </tr>
                        <tr>
                            <td>{{ __('Hourly') }}</td>

                            <td><input type="number" step="any" min="0" name="hourly" class="form-control"
                                    value="{{ old('hourly', $row->hourly) }}" placeholder="{{ __('Hourly') }}"></td>

                            <td><input type="number" step="any" min="0" name="discounted_hourly"
                                    class="form-control" value="{{ old('discounted_hourly', $row->discounted_hourly ?? $row->hourly) }}"
                                    placeholder="{{ __('Hourly') }}"></td>
                        ...
                        <tr>
                            <td>{{ __('Daily') }}</td>
                            <td> <input type="number" min="0"  name="daily" class="form-control"
                                    value="{{ old('daily', $row->daily) }}" placeholder="{{ __('Daily') }}"></td>

                            <td><input type="number" step="any" min="0" name="discounted_daily"
                                    class="form-control" value="{{ old('discounted_daily', $row->discounted_daily ?? $row->daily) }}"
                                    placeholder="{{ __('Daily') }}"></td>
                        ...
                        <tr>
                            <td>{{ __('Weekly') }}</td>
                            <td> <input type="number" step="any" min="0" name="weekly" class="form-control"
                                    value="{{ old('weekly', $row->weekly) }}" placeholder="{{ __('Weekly') }}"> </td>
                            <td><input type="number" step="any" min="0" name="discounted_weekly"
                                    class="form-control" value="{{ old('discounted_weekly', $row->discounted_weekly ?? $row->weekly) }}"
                                    placeholder="{{ __('Weekly') }}"></td>
                        ...
                        <tr>
                            <td>{{ __('Monthly') }}</td>
                            <td><input type="number" step="any" min="0" name="monthly" class="form-control"
                                    value="{{ old('monthly', $row->monthly) }}" placeholder="{{ __('Monthly') }}"> </td>
                            <td><input type="number" step="any" min="0" name="discounted_monthly"
                                    class="form-control" value="{{ old('discounted_monthly', $row->discounted_monthly ?? $row->monthly) }}"
                                    placeholder="{{ __('Monthly') }}"></td>
                            ...
                            <div class="item" data-number="{{ $key }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <label>
                                            <input @if (!is_default_lang()) disabled @endif type="checkbox"
                                                min="0" name="extra_price[{{ $key }}][per_person]"
                            ...
                            <div class="col-md-3">
                                ...
                                <label>
                                    <input type="checkbox" min="0"
                                        __name__="extra_price[__number__][per_person]" class="form-control"
                                        value="on">
                                    {{ __('Price per person') }}
                                </label>
                            </div>
