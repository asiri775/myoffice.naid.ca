...
<div class="panel">
    <div class="panel-title"><strong>{{__("Default Timings")}}</strong></div>
        ...
        <div class="row">
            <div class="col-md-6 col-12">
                <div class="form-group">
                    ...
                    <input value="{{old('available_from', $row->available_from)}}" step="3600" type="time"
                           id="available_from"
                           name="available_from" placeholder="Select Available From"
                           class="form-control">
                </div>
            </div>
            <div class="col-md-6 col-12">
                <div class="form-group">
                    ...
                    <input value="{{old('available_to', $row->available_to)}}" step="3600" type="time" id="available_to"
                           name="available_to" placeholder="Select Available To"
                           class="form-control">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12" id="hourStayReq">
                <div class="form-group">
            ...
            <div class="col-lg-12" id="dayStayReq">
                <div class="form-group">
...
<div class="panel">
    ...
    <div class="panel-body">
        <div style="display: none;"><textarea name="block_timings" id="block_timings"></textarea></div>
