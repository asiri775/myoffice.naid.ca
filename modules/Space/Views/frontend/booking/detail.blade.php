...
@endif -->
        ...
        <div class="review-section">
            <div class="section-booking-date p-2">
             <p class="service-name-booking-text text-uppercase" style="font-family: inherit;font-size:12px !important">{{ __('Booking Date and time') }}</p>
             <ul class="review-list">
                @if ($booking->start_date)
                    <li>
                        <div class="label">&nbsp;&nbsp;&nbsp;&nbsp;
                            <img src="{{asset('/images/icons/svg/015-planedown.svg')}}" alt="" style="width: 20px;height:20px;border-radius:50%;background-color:white">
                        </div>
                        <div class="val">
                    ...
                    <li>
                        <div class="label">&nbsp;&nbsp;&nbsp;&nbsp;
                        <img src="{{asset('/images/icons/svg/016-planeup.svg')}}" alt="" style="width: 20px;height:20px;border-radius:50%;background-color:white">
                        </div>
                    ...
                    @if ($platform == 'mobile')
                        <li>
                            <div class="label">&nbsp;&nbsp;&nbsp;&nbsp;
                                 <img src="{{asset('/icon/man.png')}}" alt="" style="width:20px;height:20px;">
                            </div>
                            <div class="val text-center w-100">
                                 ...
                                 <span class="text-muted" style="font-size:8px">Capacity: {{ $booking->service['max_guests'] }} Guests</span>
                            </div>
                        </li>
                    @endif
                    @if ($platform != 'mobile')
                    <li>
                        <div class="label">&nbsp;&nbsp;&nbsp;&nbsp;
                        <img src="{{asset('/icon/man.png')}}" alt="" class="mt-2" style="width:20px;height:20px;">
                        </div>
             ...
             <div class="cotainer text-center py-3 ">
                 <a href="javascript:;" id="openCalendar" style="font-weight: 600;font-size:12px">View Full Availabilty Calendar</a>
             </div>
            </div>
        </div>
            ...
            <ul class="review-list">
                @if ($booking->start_date)
                    @php
                        ...
                        $bookingPriceDetails = \App\Helpers\CodeHelper::getSpacePrice($space, $booking->start_date, $booking->end_date, $booking->id);
                        ...
                        <table class="booking-table-listing"
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td width="20%">{{ format_money($booking->total - $booking->paid) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    @endif
