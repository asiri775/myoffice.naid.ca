                        ...
                        <div class="row">
                            <div class="col col-mix">
                                <div class="form-group">
                                    <label>Address</label>
                                    <input type="text"
                                        class="form-control filterField" name="address" id="filterSearch"
                            ...
                            <div class="col col-mix">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control filterField" name="earnings_from" id="filterSearch"
                            ...
                            <div class="col col-mix">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        class="form-control filterField" name="earnings_to" id="filterSearch"
                                        placeholder="Enter Earnings">
                                </div>
                            </div>
                            <div class="col col-mix">
