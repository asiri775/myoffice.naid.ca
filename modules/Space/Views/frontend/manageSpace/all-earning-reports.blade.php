                ...
                <div class="card-header card-header-actions">
                    ...
                    <div class="card-actions">
                        <div class="table-top-filter-length-main mr-3">
                            <span>Space</span>
                            <select class="table-top-filter-length" id="filter-by-space-id">
                                <option value="">All</option>
                                <?php
                                if($userSpaces!=null){
                                    foreach($userSpaces as $userSpace){
                                        ?>
                                <option value="{{ $userSpace->id }}">{{ $userSpace->title }}</option>
                                <?php
                                    }
                                }
                                ?>
