            ...
            <div class="row">
                <div class="col-lg-6 col-sm-12 table-booking-view">
                    ...
                    <div class="card card-default full-height card-bordered p-4 card-radious">
                                    ...
                                    <table class="table">
                                        <tbody>
											...
											<!---
												   ...
												   -->
												   <a href="{{route('user.profile.publicProfile',[ 'id' => $booking->vendor_id ]) }}" title="Host Profile">
                                                ...
                                                <td colspan="3" style="text-align:center;"><a href= "{{route('space.detail',[ 'slug' => $space->slug ])}}" >{{ $space->title }}</a></td>
                                            </tr>
                                            <tr>
                                                <td class="w-20">
                                            ...
                                            <tr>
											<td class="w-20">
                                                <a href="{{route('user.profile.publicProfile',[ 'id' => $booking->customer_id ]) }}" title="Guest Profile">
													<span class="thumbnail-wrapper circular inline">
                                                        <img src="{{ $booking->vendor->getAvatarUrl() }}" alt=""
                                                            data-src="{{ $booking->vendor->getAvatarUrl() }}"
                                                            data-src-retina="{{ $booking->vendor->getAvatarUrl() }}"
												...
												{{ $booking->first_name }} {{ $booking->last_name }}  |  {{ $booking->total_guests }} <?php if($booking->total_guests > 1) {echo "Guests";} else{ echo "Guest"; } ?>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="row item-table">
                            <div class="col-sm-12">
                                ...
                                <div class="view-btn text-center mt-4 mb-3 bottom-btn">
                                    ...
                                    <button data-toggle="modal" data-target="#contactBookModal" class="btn btn-primary btn-lg mb-2">Contact Host</button>
                                </div>
                            </div>
				        </div>
                        ...
                        <div class="card mt-3 card-default full-height-n card-bordered p-4 card-radious payment-card">
                          ...
                          <div class="payment-info">
                                <div class="info">
                                    ...
                                    <div class="info-data">
                                        <h5 class="payment-method" style="width:200px;text-align:center;">{{ strtoupper($payment['method']) }}</h5>
						...
						<a target="_blank" href="{{route('space.detail',[ 'slug' => $space->slug ])}}" class="btn btn-primary">
                            View Full Listing Details
                        </a>

							<a data-toggle="modal" data-target="#contactBookModal" class="btn btn-primary">Contact Host</a>
						</div>
                ...
                <div class="modal fade" id="schedulemodal1" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
							...
							<h5 style="font-family:Montserrat;font-size:16pt;font-weight:900;" class="modal-title text-center w-100"><img width="30" height="30" src="<?php echo url('/icon/mo_cancel.svg');?>" />&nbsp;&nbsp;BOOKING #{{$booking->id}}: SCHEDULE<hr/></h5>
						    </div>
		...
		<button type="button" class="btn btn-primary" data-dismiss="modal">Ok</button>
                ...
                <div class="modal fade" id="termsmodal" role="dialog">
                    <div class="modal-dialog modal-dialog-scrollable modal-lg">
                        ...
                        <div class="modal-content">
                            <div class="modal-header justify-content-between">
							<h5 style="font-family:Montserrat;font-size:16pt;font-weight:900;" class="modal-title text-center w-100">&nbsp;&nbsp;Your Host's Terms of Service<hr/></h5>
                ...
                <div class="modal fade" id="cancelmodal" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header justify-content-between">
														  <button type="button" class="close" data-dismiss="modal">&times;</button>
		    	 <h5 style="font-family:Montserrat;font-size:16pt;font-weight:900;" class="modal-title text-center w-100"><img width="30" height="30" src="<?php echo url('/icon/mo_cancel.svg');?>" />&nbsp;&nbsp;BOOKING #{{$booking->id}}: CANCEL<hr></h5>
						    
							</div>
                            <div class="modal-body justify-content-between">
							 <p class="text-center" style="font-size:12pt;">Are you sure you want to Cancel this Booking?</p>
                            ...
                            <div class="modal-footer justify-content-center">
                                <form method="post" action="{{ route('user.bookings.get.cancel') }}">
                                    @csrf
                                    <input type="hidden" class="form-control" name="booking_id" id="booking_id" value="{{ $booking->id }}">
                                    <button type="submit" id="cancelconfirmyes" class="btn btn-primary modalbtn">Yes</button>
                                </form>
                ...
                <div class="modal fade" id="changestatusmodal" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header justify-content-between">
						  <button type="button" class="close" data-dismiss="modal">&times;</button>
		    	 <h5 style="font-family:Montserrat;font-size:16pt;font-weight:900;" class="modal-title text-center w-100">
				 <img width="30" height="30" src="<?php echo url('/icon/mo_statuschange.svg');?>" />&nbsp;&nbsp;BOOKING #{{$booking->id}}: CHANGE STATUS<hr></h5>
							</div>
                            <div class="modal-body justify-content-between text-center w-200">
							<center>
							 <p class="text-center w-200" style="font-size:12pt;">Your Booking Status cannot be changed once you have Checked OUT.</p>
							&nbsp;&nbsp; 
							 <p class="text-center w-200" style="font-size:12pt;">If you have Checked OUT in error, please contact your Host to change your Booking Status.</p>
							&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 
									</center>	
						<div class="clearfix"></div>
							<button type="button" class="text-center btn btn-primary" data-dismiss="modal">Ok</button>
...
<h5 style="font-family:Montserrat;font-size:16pt;font-weight:900;" class="modal-title tex-center w-100"><img width="30" height="30" src="<?php echo url('/icon/mo_calendar.svg');?>" />&nbsp;&nbsp;BOOKING #{{$booking->id}}: SCHEDULE<hr></h5>
   <button type="button" class="close" data-dismiss="modal">&times;</button>
						</div>
                            <hr>
				...
				display: none; 
								...
								<input type="hidden" id="booking_id" name="booking_id" value="{{$booking->id}}" />
										<div class="date-select" style="background-color:#FFFFFF;padding-left:10px;padding-right:10px;padding-bottom:5px;">
											<div class="detailsbooking fulwidthm left mgnB10 pdgB15 dobordergry mt-5 mb-3">
												<div class="input-daterange" id="datepicker">
													<div class="detailformrow mgnB15 left fulwidthm @if (!$showTimingOption) non-time @endif">
                                                	 ...
                                                	 <input id="dpd1x1" name="newstart_date" style="width:35%;border-radius:10px;border-top:1px solid lightgrey;border-left:1px solid lightgrey;border-color:lightgrey;height:50px;"   type="date" value="<?php echo date("d-m-Y"); ?>" >
                											&nbsp;&nbsp;
															<select class="selectsearch" style="height:50px;width:26%;border-radius:10px;border-color:lightgrey;" name="newstart_hour" id="start_hour">
																<option value="">Start Time</option>
																@foreach ($allDayTimeSlots as $slot)
																	@if ($slot >= $space->available_from && $slot <= $space->available_to)
																		<option @if ($startTime == $slot) @endif value="{{ $slot }}">
																			{{ $slot }}</option>
																	@endif
																@endforeach
															</select>
													...
													<div  class="detailformrow mgnB15 left fulwidthm  @if (!$showTimingOption) non-time @endif">
														...
														<img width="30" height="30" src="<?php echo url('/icon/mo_depart.svg'); ?>">
                                                			<input id="dpd2x2" name="newend_date" placeholder="End Date"  style="width:35%;border-radius:10px;border-left:1px solid lightgrey;border-top:1px solid lightgrey;border-color:lightgrey;height:50px;" type="date" value="<?php echo date("d-m-Y");?>" >
														&nbsp;&nbsp;
														<select class="selectsearch" style="width:26%;height:50px;border-radius:10px;border-color:lightgrey;" name="newend_hour" id="end_hour">
																<option value="" selected>End Time</option>
																@foreach ($allDayTimeSlots as $slot)
																	@if ($slot >= $space->available_from && $slot <= $space->available_to)
																		<option @if ($endTime == $slot)  @endif value="{{ $slot }}">
																			{{ $slot }}</option>
																	@endif
																@endforeach
															</select>
                            ...
                            <div class="modal-footer justify-content-between">
                                <form method="post" action="{{ route('user.booking.reschedule') }}">
                                    @csrf
                                    <input type="hidden" class="form-control" name="booking_id" id="booking_id" value="{{ $booking->id }}">
                                    <input type="hidden" class="form-control" name="newstart_date" id="newstart_date" value="">
                                    <input type="hidden" class="form-control" name="newend_date" id="newend_date" value="">
                                   <button type="submit" id="rescheduleyes" class="btn btn-primary modalbtn">Save Changes</button>
                                 <button type="button"   class="btn btn-primary"  data-dismiss="modal">Cancel</button>
								</form>
                           </div>
                    <div class="detailformrow mgnB15  fulwidth avl-cal text-center w-100" >
						<a href="void()" id="openCalendar" style="font-size:10pt;margin-left:5px;margin-bottom:10px;">Click Here to See Availability Calendar</a>
					</div>
						</div>
                    </div>
                </div>
				<!-- Modal -->
<div id="availabilityCalendar" class="modal" tabindex="-1" role="dialog" style="vertical-align: middle;">
    <div class="modal-dialog modal-lg modal-dialog-centered" style="vertical-align: middle;">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family:Montserrat;font-size:16pt;font-weight:900;" class="modal-title">Availability Calendar</h5>
                ...
                <div class="modal fade" id="contacthostmodal" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 style="font-family:Montserrat;font-size:16pt;font-weight:900;" class="modal-title">Contact Guest</h4>
                            </div>
                            <div class="modal-body">
                                <form method="post" class="" action="{{ route('user.booking.contactguest') }}">
								    ...
								    <div class="form-group">
										...
										<input type="text" class="form-control" name="listing_name" id="listing_name" value="{{ $space->title }}">
									</div>
											
								    <div class="form-group">
										<label>Arrival Time:</label>
										<input type="text" class="form-control" name="arrival_time" id="arrival_time" value="{{ $booking->start_date }}">
									</div>
						
								    <div class="form-group">
										<label>Departure Time:</label>
										<input type="text" class="form-control" name="departure_time" id="departure_time" value="{{ $booking->end_date }}">
									</div>

								    <div class="form-group">
										<label>Cancellation Fee:</label>
										<input type="text" class="form-control" name="cancellation_fee" id="cancellation_fee" value="">
									</div>
                ...
                <div class="modal fade" id="thankyoumodal" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 style="font-family:Montserrat;font-size:16pt;font-weight:900;" class="modal-title">Thank you Email.</h4>
                            </div>
                            <div class="modal-body">
        ...
        setTimeout(e => {
            checkTimeAvailability(false);
				...
				$(document).ready(function() 
					...
					{
					$("#changedropdown .dropdown-menu").html("<a class='' style='text-align:center;margin-top:5px;border-radius:20px;background-color:#ffd700;width:150px;height:30px;' href='#'>CHECKED IN</a>");
					}

					if ($("#bookingstatus").val()=="checked in")
					{
					$("#changedropdown .dropdown-menu").html("<a class='' style='text-align:center;margin-top:5px;border-radius:20px;background-color:#00ffff;width:150px;height:30px;' href='#'>CHECKED OUT</a>");
					}
					...
					{
						if ($("#newstart_date").val()=="" || $("#newend_date").val()=="" || $("#start_hour").val()=="" ||  $("#start_hour").val()=="")
						{
							e.preventDefault();
						...
						if ($("#newstart_date").val() !="" && $("#newend_date").val() != "" && $("#start_hour").val() != "" && $("#end_hour").val() != "")
						{
							return true;
						}
					...
					$(".booking-h-actions #changestatus").click(function()
						{
								bookingstatus=$("#bookingstatus").val();
								if ( bookingstatus=="checked out" || bookingstatus=="completed" || bookingstatus=="complete")
								{
						...
						elementselector="#schedulemodal #dpd1x1, #schedulemodal #dpd2x2, #schedulemodal #start_hour, #schedulemodal #end_hour";
							...
							$.ajaxSetup({
								headers: {
									...
									$.ajax({
										...
										data: {'id':id1,'start_date':start1,'end_date':end1,'start_time':starttime1,'end_time':endtime1},
										success: function (data1) 
										{
											if (data1.status=="success")
											{
												$("#schedulemodal .modal-body p").css('color','green');
												$("#schedulemodal .modal-body p").html('The Date/Time you selected is Available.');
											}
											if (data1.status=="bookingexists")
											{
									$("#schedulemodal #msgbox").css('color','red');
									$("#schedulemodal #msgbox").html('The Date/Time you selected is Unavailable. Please make another selection.');
											}
											if (data1.status=="error1")
											{
									$("#schedulemodal #msgbox").css('color','red');
									$("#schedulemodal #msgbox").html('Booking Start Date Time cannot be lesser than current time. Please make another selection.');
											}
											if (data1.status=="error2")
											{
									$("#schedulemodal #msgbox").css('color','red');
									$("#schedulemodal #msgbox").html('Booking End Date Time cannot be lesser than current time. Please make another selection.');
											}
							...
							$.ajaxSetup({
								headers: {
									...
									$.ajax({
										...
										data: {'id':id1,'start_date':start1,'end_date':end1,'extendtime':extendtime1},
										success: function (data1) 
										{
											if (data1.status=="success")
											{
												...
												$("#extendmodal .modal-body p").html('Extended Booking Time Available');
											...
											if (data1.status=="bookingexists")
											{
												...
												$("#extendmodal .modal-body p").html('Extended Booking Time Not Available');
                       ...
                       <!-- Modal content-->
                        <div class="modal-content ">
                            <div class="modal-header  justify-content-between text-center">
                                <h5 style="font-family:Montserrat;16pt;font-weight:900;" class="modal-title justify-content-between text-center w-100" ><img width="30" height="30" src="<?php echo url('/icon/mo_share1.svg'); ?>">&nbsp;&nbsp;BOOKING #{{ $booking->id }}: SHARE</h5>
							    <button type="button" class="close" data-dismiss="modal">&times;</button>
							</div>
							<hr style="width:94%;text-align:left;margin-left:15">
                            <div class="modal-body justify-content-between text-center">
                             	<form method="post"  action="{{ route('user.booking.sendbooking') }}" style="margin-top:5px;">
                                    @csrf
								<label>Please share the destination E-Mail Address:	</label>
                                <input type="hidden"  class="form-control" name="booking_id" id="booking_id" value="{{ $booking->id }}">
								<center>
								<input type="email"  style="margin-top:15px;" placeholder="email@myoffice.ca" class="form-control form-rounded w-50"  name="sendemailaddress" id="sendemailaddress" value="">
							</div>
                            <div class="modal-footer justify-content-center text-center">
                                <button type="submit" id="sendbookingconfirmyes" class="btn btn-primary">Send Message</button>
                            	<button type="button" style="margin-top:-1px;" class="btn btn-primary w-40" data-dismiss="modal">Cancel</button>
                                 </form>
                           </div>
                        </div>
							  ...
							  <div class="modal fade" id="extendmodal" role="dialog">
								<div class="modal-dialog modal-md">
								  <div class="modal-content">
									<div class="modal-header">
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
								    <h5 style="font-family:Montserrat;16pt;font-weight:900;" class="modal-title justify-content-between text-center w-100" ><img width="30" height="30" src="<?php echo url('/icon/mo_share1.svg'); ?>">&nbsp;&nbsp;BOOKING #{{ $booking->id }}: EXTEND</h5>
									</div>
									<hr style="width:94%;text-align:left;margin-left:15">
                            		<div class="modal-body justify-content-center text-center">
									<center>
									  <h6 style="font-size:10pt;margin-bottom:5px;width:200px;font-weight:300;" class="text-center">Please select the length of time you wish to Extend this booking</h6>
									</center>		
									 <form id="extendtimeform" style="position:relative;margin-top:12px;" action="{{ route('user.booking.extendbooking') }}" method="post" >
									  @csrf
									  <p></p>
        							  <input type="hidden" class="form-control" name="booking_id" id="booking_id" value="{{ $booking->id }}">
        							  <input type="hidden" class="form-control" name="start_date" id="start_date" value="{{ $booking->start_date }}">
        							  <input type="hidden" class="form-control" name="end_date" id="end_date" value="{{ $booking->end_date }}">
									<center>
									<select class="form-control  w-50" name="extendtime" id="extendtime">
										<option value="" style="text-align:center;">--Select Extend Time--</option>
									...
									<div class="modal-footer" style="justify-content: center;">
									  ...
									  <button type="button" id="confirmno" style="margin-top:-1px;" class="btn btn-primary" data-dismiss="modal">No</button>
									</div>
							  ...
							  <div class="modal fade" id="confirmmodal1" role="dialog">
								<div class="modal-dialog modal-md">
								  <div class="modal-content">
									<div class="modal-header justify-content-between">
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
									  <h4 style="font-family:Montserrat;font-size:16pt;font-weight:900;" class="modal-title text-center w-100"><img width="30" height="30" src="<?php echo url('/icon/mo_statuschange.svg');?>" />&nbsp;&nbsp; BOOKING #{{$booking->id}}: MODIFY STATUS<hr></h4>
									</div>
								    ...
								    <form method="post" action="{{ route('user.booking.statuschange') }}">
									  ...
									  <label for="confirmtype1" style="">CURRENT STATUS</label><br/>
										<div id="status-btn" style="margin-top:4px;padding-top:9px;justify-content:center;height:40px;width:200px;" class="status-btn <?= $booking->statusClass() ?>">
										<?php 
										...
										<input type="hidden" class="form-control" name="changetostatus" id="changetostatus" value="">
										<label for="changetotype" style="margin-top:8px;">CHANGE STATUS TO</label>
										<div class="dropdown" id="changedropdown">
										  <button class="btn btn-primary dropdown-toggle"  style="width:180px;" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										  ---Select---
										  </button>
										  <div class="dropdown-menu" style="padding-left:15px;width:180px;" aria-labelledby="dropdownMenuButton">
										  </div>
										</div>
										<!---
							  ...
							  <div class="modal fade" id="confirmmodal" role="dialog">
								<div class="modal-dialog modal-sm">
								  <div class="modal-content">
									<div class="modal-header">
									  <button type="button" class="close" data-dismiss="modal">&times;</button>
									  <h4 style="Montserrat;font-size:16pt;font-weight:900;" class="modal-title">Confirm Modal</h4>
									</div>
									<div class="modal-body">
									  <p></p>
									...
									<div class="modal-footer">
									  <button type="button" id="confirmyes" class="btn btn-default" data-dismiss="modal">Yes</button>
									  <button type="button" id="confirmno" class="btn btn-default" data-dismiss="modal">No</button>
									</div>
								  </div>
                ...
                <div class="col-lg-6 col-sm-12 tab-view">
                    <div class="title title-fonts sub-title">
                        ...
                        <div class="booking-h-statuses">
                        	@if ($booking->status=="Booked"  or $booking->status=="booked" or $booking->status=="scheduled" or $booking->status=="Scheduled")
							<ul>
                                <li>
                                    <div class="b-h-status completed" id="bookingstatus">
                                        <span class="box">
                                ...
                                <li>
                                    <div class="b-h-status" id="checkinstatus">
                                        <span class="box">
                                ...
                                <li>
                                    <div class="b-h-status" id="checkoutstatus">
                                        <span class="box">
                                            <i class="fa fa-close"></i>
                                        </span>
                                ...
                                <li>
                                    <div class="b-h-status" id="completedstatus">
                                        <span class="box">
                                            <i class="fa fa-close"></i>
                                        </span>
                                        <span>Complete</span>
							...
							@if ($booking->status == "CheckedIn" or $booking->status == "checkedin" or $booking->status == "checked in" )
							<ul>
                                <li>
                                    <div class="b-h-status completed" id="bookingstatus">
                                        <span class="box">
                                ...
                                <li>
                                    <div class="b-h-status completed" id="checkinstatus">
                                        <span class="box">
                                            <i class="fa fa-check"></i>
                                        </span>
                                        <span>Checked In</span>
							...
							@if ($booking->status == "CheckedOut" or $booking->status == "checkedout" or $booking->status == "checked out" )
							<ul>
                                <li>
                                    <div class="b-h-status completed" id="bookingstatus">
                                        <span class="box">
                                ...
                                <li>
                                    <div class="b-h-status completed" id="checkoutstatus">
                                        <span class="box">
                                            <i class="fa fa-check"></i>
                                        </span>
                                        <span>Checked Out</span>
							...
							@if ($booking->status == "Completed" or $booking->status == "completed" or $booking->status == "complete") 
							<ul>
                                <li>
                                    <div class="b-h-status completed" id="bookingstatus">
                                        <span class="box">
							...
							@if ($booking->status == "draft" or $booking->status == "Draft" or $booking->status == "" or $booking->status == "Cancelled" or $booking->status == "unpaid" or $booking->status == "Unpaid" or $booking->status == "pending" or $booking->status == "Pending")
							<ul>
                                <li>
                                    <div class="b-h-status" id="bookingstatus">
                                        <span class="box">
                                            <i class="fa fa-close"></i>
                                        </span>
										<span>Booked</span>
					...
					<div class="card" style="border-radius:25px;">
					  ...
					  <div class="card-body">
						...
						<input type="button" data-toggle="modal"
                                data-target="#rateHostSingleBooking<?= $booking->id ?>" class="btn btn-primary" value="SUBMIT REVIEW">
						</p>
					 </div>
					</div>
					</div>
					...
					<div class="promotion mt-6" style="width:100%;border-radius:25px;">
					<div class="card" style="border-radius:25px;">
					  <div class="card-header text-center w-100" style="font-weight:900;">GREAT PLACE TO WORK</div>
					  <div class="card-body">
						<table>
						<tr>
						<td><img src="{{ asset('images/avatar-1.jpg') }}"></td>
						<td style="padding-left:20px;padding-right:20px;">I love working out of this place. The people are friendly and it's a great vibe
							<br/>John Doe, October 2023
						</td>
