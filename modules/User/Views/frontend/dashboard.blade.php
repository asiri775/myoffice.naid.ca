                ...
                <div class="card-header card-header-actions">
                    <div class="card-title">
                        <ul class="card-in-rows-options bookingFilters">
                            ...
                            <li><a href="javascript:;" data-value="draft" class="">Draft</a></li>
                            <li><a href="javascript:;" data-value="processing" class="">Processing</a></li>
                            <li><a href="javascript:;" data-value="confirmed" class="">Confirmed</a></li>
                            <li><a href="javascript:;" data-value="complete" class="">Completed</a></li>
                        </ul>
                    </div>
                    <div class="card-actions">
