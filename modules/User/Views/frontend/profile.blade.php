                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mobileNoFieldDataParent">
                                            ...
                                            <input type="text" value="{{ old('phone', $dataUser->phone) }}"
                                                placeholder="{{ __('Phone Number') }}"
                                                class="form-control mobileNoFieldData">
                                            <input type="hidden" value="{{ old('phone', $dataUser->phone) }}"
                                                name="phone" class="real">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" style="font-size: 24px;font-weight: 700;text-transform: uppercase;font-family: 'MONTSERRAT';">{{ __('Select Avatar') }}</h4>
                ...
                .then(file => {
                    ...
                    $.ajax({
                        ...
                        success: function(res) {
                            ...
                            $('.avatar-selector .img-box').attr("style", `background-image: url('${res?.url}')`);
                            $("#profile-pic-gallery-modal").modal("hide");
                        },
                        error: function(e) {
                            console.log(e);
            ...
            google.maps.event.addListener(autocomplete, 'place_changed', function() {
                ...
                for (let addressComponent of place.address_components) {
                    if (addressComponent['types'].includes("locality")) {
                        ...
                        document.getElementById("state").value = addressComponent.long_name;
