							...
							<div class="modal fade" id="extendmodal" role="dialog">
								<div class="modal-dialog modal-md">
								  <div class="modal-content">
									...
									<form id="extendtimeform" action="{{ route('user.booking.extendbooking') }}"  style="position:relative;margin-top:12px;"method="post" >
									  @csrf
									  <p></p>
        							  <input type="hidden" class="form-control" name="booking_id" id="booking_id" value="{{ $booking->id }}">
...
<h5 style="font-family:Montserrat;font-size:16pt;font-weight:900;" class="modal-title tex-center w-100"><img width="30" height="30" src="<?php echo url('/icon/mo_calendar.svg');?>" />&nbsp;&nbsp;BOOKING #{{$booking->id}}: SCHEDULE<hr></h5>
   <button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="detailformrow mgnB15  fulwidth avl-cal text-center w-100" >
						<a href="" id="openCalendar" style="font-size:10pt;margin-left:5px;margin-bottom:10px;">Click Here to See Availability Calendar</a>
					</div>
						</div>
                    </div>
                </div>
						...
						$(elementselector).change(function()
						{
							...
							$.ajaxSetup({
								headers: {
									...
									$("#schedulemodal .modal-body p").html('The Date/Time you selected is Unavailable. Please make another selection.');
											}
											if (data1.status=="error1")
											{
									$("#schedulemodal .modal-body p").css('color','red');
									$("#schedulemodal .modal-body p").html('Booking Start Date Time cannot be lesser than current time. Please make another selection.');
											}
											if (data1.status=="error2")
											{
									$("#schedulemodal .modal-body p").css('color','red');
									$("#schedulemodal .modal-body p").html('Booking End Date Time cannot be lesser than current time. Please make another selection.');
											}
									  ...
									  <label for="confirmtype1" style="">CURRENT STATUS</label><br/>
										...
										<div class="dropdown" id="changedropdown">
										  ...
										  <div class="dropdown-menu" style="padding-left:15px;width:180px;" aria-labelledby="dropdownMenuButton">
								  	       <a class='' style='text-align:center;margin-top:5px;border-radius:20px;background-color:#ffd700;width:150px;height:30px;color:#fff;' href='#'>BOOKED</a>
											<a class='' style='text-align:center;margin-top:5px;border-radius:20px;background-color:#ffC107;width:150px;height:30px;' href='#'>CHECKED IN</a>
											...
											<a class='' style='text-align:center;margin-top:5px;border-radius:20px;background-color:#7aa41f;width:150px;height:30px;color:#fff;' href='#'>COMPLETED</a>
										  </div>
										</div>
										<!---
