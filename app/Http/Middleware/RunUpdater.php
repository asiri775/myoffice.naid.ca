...
<a href="mailto:contact@bookingcore.com">contact@bookingcore.com</a>',
            ...
            if (empty(setting_item('space_search_fields'))) {
                DB::table('core_settings')->insert(
                    [
                        ...
                        'val'   => '[{"title":"Location","field":"location","size":"3","position":"1"},{"title":"From - To","field":"date","size":"3","position":"2"},{"title":"Time From - Time To","field":"time","size":"3","position":"3"},{"title":"Guests","field":"guests","size":"3","position":"4"}]',
                        'group' => 'tour'
                    ]
                );
            }
        ...
        public function updateTo220()
        {
            ...
            Schema::table('bravo_bookings', function (Blueprint $table) {
                if (!Schema::hasColumn('bravo_bookings', 'coupon_code')) {
