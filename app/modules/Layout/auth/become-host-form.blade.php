<form class="form bravo-form-register" action="{{ route('auth.host.register') }}" method="POST">
    @csrf
    <div class="row">
    ...
    <div class="form-group">
        <label class="formlabel fontsize13 robotoregular graytext font-weight-bold">Country of Residence
            <span class=" required">*</span></label>
            <select id="country" class="formselect form-control" style="width:100%"
    ...
    <div class="row">
        ...
        <div class="form-group password">
            ...
            <a href="javascript:;" class="togglePassField"><i class="input-icon icofont-eye-blocked"></i></a>
        ...
        <div class="form-group password">
            <label class="formlabel fontsize13 robotoregular graytext font-weight-bold">Confirm Password
                <span class=" required">*</span></label>
            <input type="text" class="form-control" name="password" autocomplete="off" placeholder="Confirm Password">
            <i class="input-icon field-icon icofont-ui-password"></i>
            <a href="javascript:;" class="togglePassField"><i class="input-icon icofont-eye-blocked"></i></a>
            <span class="invalid-feedback error error-password"></span>
        </div>
       ...
       <div class="form-group">
        ...
        <div class="advanced">
        <p class="text-center f14 c-grey">Already a MyOffice member? <a href="{{ route("login") }}" class="gray-text">Log In</a></p>
        </div>
