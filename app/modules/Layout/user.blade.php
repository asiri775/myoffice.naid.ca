...
<head>
    ...
    @include('Layout::Other.parts.seo-meta')
...
<body class="user-page {{$body_class ?? ''}} @if(setting_item_with_lang('enable_rtl')) is-rtl @endif">
    ...
    <div class="bravo_wrap">
        @include('Layout::Other.parts.topbar')
        @include('Layout::Other.parts.header')
                ...
                <div class="row row-eq-height">
                    ...
                    <div class="col-md-9">
                        <div class="user-form-settings">
                            @include('Layout::Other.parts.user-bc')
                            @yield('content')
                        </div>
                    </div>
                </div>
        ...
        @include('Layout::Other.parts.footer',['is_user_page'=>1])
    </div>
