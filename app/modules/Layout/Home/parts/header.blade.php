...
<div class="indexheaderwrper innerheader whitebg">
    <div class="container-fluid">
        <div class="indexlogo pull-left ">
            <a href="/" class="fulwidthm left"><img src="{{ asset('images/logo_myoffice.png') }}" alt="MyOffice Logo"
                    title="MyOffice"></a>
        </div>
        ...
        <ul class="menu">
            <li class="has-submenu">
                ...
                <ul class="sub-menu">
                    <?php
                    $space_attrs = Modules\Core\Models\Attributes::where('service', 'space')->orderBy('position', 'asc')->get();
                    ?>
                    @foreach ($space_attrs as $space_attr)
                        <li><a
                                href="/space?_layout=map&long_term_rental=&search_type=&map_place=&map_lat=&map_lgn=&start=&end=&date=&from_hour=&to_hour=&adults=&terms[]={{ $space_attr->id }}">{{ $space_attr->name }}</a>
                        </li>
                    @endforeach
                </ul>
            </li>
            <li class="has-submenu">
                <a class="" href="/page/guests-how-it-works" title="How It Works">How It Works</a>
                <ul class="sub-menu">
                    <li>
                        <a href="#">Guests</a>
                    </li>
            ...
            <li>
                <a class="" href="/page/concierge" title="Concierge">Concierge</a>
            </li>
            @if (!Auth::id())
                <li class="">
                ...
                <li class="dropdown-notifications dropdown p-0">
                    ...
                    <ul class="dropdown-menu overflow-auto notify-items dropdown-container dropdown-menu-right dropdown-large">
                        <div class="dropdown-toolbar">
                            <h3 class="dropdown-toolbar-title text-center">{{ __('Notifications') }} (<span  class="notif-count">{{ $countUnread }}</span>)</h3>
                        </div>
        ...
        <li class="dropdown loged">
            ...
            <ul class="dropdown-menu text-left width-auto">
                ...
                @endif
                <li class="menu-hr"><a href="{{ route('user.bookings.details').'?type=history' }}"><i class="fa fa-clock-o"></i>
