...
<head>
    ...
    <!-- Styles -->
    <link href="http://booking.myoffice.ca/module/space/css/space.css?_ver=1.6.1" rel="stylesheet">
    <style type="text/css">
        .bravo_topbar,
        .bravo_footer {
            display: none
    ...
    <link href="http://booking.myoffice.ca/en/custom-css" rel="stylesheet">
    <link href="http://booking.myoffice.ca/libs/carousel-2/owl.carousel.css" rel="stylesheet">
    ...
    <script type="text/javascript"
            src="http://maps.googleapis.com/maps/api/js?key=AIzaSyA2Onc2s6bBRuIb8j9aBT8X_N3ZnaiwBQw&sensor=false&libraries=places"></script>
...
@include('Layout::Home.parts.footer-new')
