                                    ...
                                    <div class="searchloactionwrp bravo-form-search-all">
                                        <div class="g-form-control">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li role="bravo_space">
                                                    <a href="#bravo_space" class="active" aria-controls="bravo_space"
                                                                            ...
                                                                            <div class="form-date-search">
                                                                                <div class="date-wrapper">
                                                                                    <div class="check-in-wrapper">
                                                                                        ...
                                                                                        @endphp
                                                                                        <label>From - To</label>
                                                                                        <div class="render check-in-render">{{$now}}</div>
                                                                                        <span> - </span>
                                                                                        <div class="render check-out-render">{{$now}}</div>
                                                                                    </div>
                                                                                </div>
                                                                                <input type="hidden" class="check-in-input" value="{{$now}}" name="start">
                                                                                <input type="hidden" class="check-out-input" value="{{$now}}" name="end">
                                                                                <input type="text" class="check-in-out" name="date" value="{{$now}} - {{$now}}">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
