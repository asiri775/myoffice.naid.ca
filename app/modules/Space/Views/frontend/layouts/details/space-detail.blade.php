    ...
    <div class="left">
        ...
        @if ($translation->address)
            <p class="address"><i class="fa fa-map-marker mr-1"></i>
               <a href="#module-location" onclick="getSelectedTabIndex();">{{ $translation->address }}</a>
            </p>
        @endif
    </div>
    <script>
...
<div class="g-space-feature">
    <div class="row">
        ...
        <div class="col-xs-6 col-lg-2 col-md-6">
            <div class="item">
                <img src="/images/parking-area.png">
                <div class="info">
    ...
    <div class="tab-pane active" id="module-photos">
        <div class="g-gallery">
            <div class="fotorama" data-width="100%" data-thumbwidth="135"
                 data-thumbheight="135" data-thumbmargin="15" data-nav="thumbs"
