...
<div class="item">
    ...
    <div class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
            ...
            <a class="dropdown-item" href="{{ route("space.search",$param) }}">{{ __("All") }}</a>
            @php $param['orderby'] = "best_rated" @endphp
            <a class="dropdown-item" href="{{ route("space.search",$param) }}">{{ __("Best Rated") }}</a>
