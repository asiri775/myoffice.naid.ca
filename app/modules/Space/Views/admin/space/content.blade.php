            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{$row->desk}}" placeholder="{{__("Example: 3")}}" name="desk"
                               class="form-control">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{$row->seat}}" placeholder="{{__("Example: 5")}}" name="seat"
                               class="form-control">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{$row->square}}" placeholder="{{__("Example: 100")}}" name="square"
                               class="form-control">
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <select name="rapidbook" id="rapidbook" class="form-control">
                            <option {{ ($row->rapidbook == 0) ? 'selected' : '' }} value="0">Off</option>
                            <option {{ ($row->rapidbook == 1) ? 'selected' : '' }} value="1">On</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <select name="free_cancellation" id="free_cancellation" class="form-control">
                            <option {{ ($row->free_cancellation == 0) ? 'selected' : '' }} value="0">Off</option>
                            <option {{ ($row->free_cancellation == 1) ? 'selected' : '' }} value="1">On</option>
                        </select>
                    </div>
                </div>
            </div>
