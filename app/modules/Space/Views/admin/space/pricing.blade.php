    ...
    <div class="panel-body">
        @if(is_default_lang())
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="form-group">
                        <label class="control-label">{{__("Hourly")}}</label>
                        <input type="number" step="any" min="0" name="hourly" class="form-control" value="{{$row->hourly}}" placeholder="{{__("Hourly")}}">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="form-group">
                        <label class="control-label">{{__("Daily")}}</label>
                        <input type="number" min="0" max="100" name="daily" class="form-control" value="{{$row->daily}}" placeholder="{{__("Daily")}}">
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="form-group">
                        <label class="control-label">{{__("Weekly")}}</label>
                        <input type="number" step="any" min="0" name="weekly" class="form-control" value="{{$row->weekly}}" placeholder="{{__("Weekly")}}"> 
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="form-group">
                        <label class="control-label">{{__("Monthly")}}</label>
                        <input type="number" step="any" min="0" name="monthly" class="form-control" value="{{$row->monthly}}" placeholder="{{__("Monthly")}}"> 
                    </div>
                </div>
            </div>
        @endif
