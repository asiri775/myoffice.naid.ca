                ...
                if ($start_date != null && $end_date != null ) {
                    ...
                    if( $start_hour_state == $start_ampm && $end_hour_state == $end_ampm)
                    {
                        ...
                        if ($startHour != null && $endHour != null) {
                            ...
                            if ($toDate > $startDate) {
                                $startHourExploded = explode(':', $startHour);
                                $endHourExploded = explode(':', $endHour);
                                    ...
                                    if ($bookingBetween != null && count($bookingBetween) > 0) {
                                        ...
                                        if ($startHour != null && $endHour != null) {
                                            if ($toDate > $startDate) {
                                                ...
                                                $bookingBetween = Booking::whereRaw("`status` != 'draft' and `object_model` = 'space' and `object_id` = " . $id . "
                                            ...
                                            OR ('$toDate' BETWEEN `start_date` and `end_date`) )")->get();
                                                ...
                                                if ($bookingBetween != null && count($bookingBetween) > 0) {
                                                    ...
                                                    $response['step'] = '0x0';
                                                    $response['message'] = 'Successfully checked the availabitily';
                                                }
                                            } else {
                                                $response['status'] = 'error';
