...
class SpaceController extends Controller
{
    ...
    public function detail(Request $request, $slug)
    {
        ...
        if($spaceTerms){
            ...
            {
                $category=Terms::where('id', $term->term_id)->where("attr_id",3)->first();
                $parking=Terms::where('id', $term->term_id)->where("attr_id",4)->first();
            }
        }
        $row['category_name']=(isset($category['name']))?$category['name']:'Uncategorized';
        $row['parking']=(isset($parking['name']))?$parking['parking']:'';
