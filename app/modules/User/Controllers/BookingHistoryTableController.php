            ...
            ->addColumn('actions', function ($booking) {
                $actions = '<div class="text-right data-tb-icon">
                                <div class="btn-group">
                                    ...
                                    <a href="#!" onclick="modalSend('.$booking->id.')" class="btn btn-share btn-icon btn-lg" data-toggle="modal" data-target="#send" trans_id="'.$booking->id.'"
                                    data-placement="bottom" title="Email"><span class="material-icons" data-toggle="tooltip" data-placement="top"
