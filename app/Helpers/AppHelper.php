...
function display_datetime_custom($time)
{
//    if (is_string($time)) {
//        $time = strtotime($time);
//    }
//    if (is_object($time)) {
//        $date =  $time->format(get_date_format());
//        $date .= '<strong style="margin: 0 5px;opacity: 0.3">|</strong>';
//        $date .=  $time->format('H:i');
//        return $date;
//    }

    $date =  date(get_date_format() , strtotime($time));
    $date .= '<strong style="margin: 0 5px;opacity: 0.3">|</strong>';
