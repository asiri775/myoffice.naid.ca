...
//        }
        ...
        public function sendEmailVerificationNotification(){
            ...
            $EmailSubject = EmailSubject::where('token', 'k15jh725')->first();
            $EmailTemplate = EmailTemplate::where('domain', 9)->where('subject_id', $EmailSubject['id'])->first();
            $a  = Mail::to($this->email)->send(new EmailUserVerifyRegister($this,$EmailSubject['subject'],$EmailTemplate,$actionUrl));   
        }
